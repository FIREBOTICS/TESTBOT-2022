...
public class RobotContainer {
  ...
  // public static VictorSPX newVictor1 = new VictorSPX(1);

  // public static VictorSPX newVictor2 = new VictorSPX(0);
  // public static VictorSPX newVictor3 = new VictorSPX(3);
